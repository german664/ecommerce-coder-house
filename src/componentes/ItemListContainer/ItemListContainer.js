...
const ItemListContainer = ({ title }) => {
    ...
    const fetchPromise = new Promise((resolve, reject) => {
        setTimeout(() => {
            resolve([
                { id: 1, price: 100000, title: "Apple Airpods Auriculares Bluetooth inalámbricos para iPhone con iOS 10", pictureUrl: "/images-promiseTest/airpods.jpg", stock: 5 },

                { id: 2, price: 150000, title: "Echo Dot (3ra Gen) - Parlante inteligente con Alexa", pictureUrl: "/images-promiseTest/alexa.jpg", stock: 8 },

                { id: 3, price: 200000, title: "Cámara fotográfica EOS Rebel T7 con juego de doble acercamiento", pictureUrl: "/images-promiseTest/camera.jpg", stock: 15 },

                { id: 4, price: 90000, title: "Apple - iPhone 11 ", pictureUrl: "/images-promiseTest/phone.jpg", stock: 18 }
            ])
        }, 2000)
    })
    ...
    useEffect(() => {
        ...
        getItemDetail(3).then(result => setItem(result))
    }, [])
    return <>
