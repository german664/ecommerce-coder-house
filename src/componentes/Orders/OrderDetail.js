...
const OrderDetail = () => {
    ...
    return (
        <Container className="mt-4">
            {
                error && <>   <Link to="/"><span className="btn btn-secondary my-3">Atrás</span></Link><div className="d-flex justify-content-center "><ErrorMessage>{errorMessage}</ErrorMessage></div></>
            }
            <Row>
